...
function MainContent({items}) {
  ...
  return (
    ...
    <Breadcrumb spacing='8px'  className="poppins-regular appdivHeader" separator={<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#999999" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg>}>
          ...
          {items.map((item, index) => (
            ...
            >
              <Checkbox
                ...
                border={checkedItems[index] ? "" : subTab === item ? "1px solid #F68623" : ""}mainAppdiv
                size="lg"
                mr={8}
              />
...
{subTab === "Market Analysis" && 
            <Flex  direction={"column"} className="subTabChat"  alignItems={"start"}  justifyContent={"space-between"} gap={"20px"} marginTop={"20px"}>
